          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">
                Sync courses, coursework, rosters, and announcements directly into Zalamati Academy
              </p>
            </div>
          </div>
          <button
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-6">
          ...
          {!token ? (
            <div className="p-6 rounded-2xl bg-gradient-to-br from-indigo-950/40 via-purple-950/20 to-black border border-indigo-500/30 flex flex-col items-center text-center space-y-4">
              ...
              <div>
                <h3 className="text-base font-bold text-white">Connect Your Google Classroom Account</h3>
                <p className="text-xs text-gray-400 max-w-md mt-1">
                  Authenticate with Google to grant permission for reading your Google Classroom courses, rosters, coursework, and announcements.
                </p>
              </div>
              ...
              >
                ...
                <span>{isLoadingAuth ? 'Connecting to Google...' : 'Sign in with Google Classroom'}</span>
              </button>
